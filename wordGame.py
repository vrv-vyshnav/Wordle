...
def scamblerMain(start):
    ...
    class Meta:
        if __name__ == '__main__':
            t1 = multiprocessing.Process(target=count, args=[30])
            t1.start
