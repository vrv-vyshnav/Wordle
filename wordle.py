...
def report(start, end,i):
    print("_____________________________________________ \n")
    print("stats! \n")
    print("\t TIme taken to find word: " + str(end - start) + " seconds")
...
try:     
    ...
    while(True):
        ...
        for wordz in wordlist:
            ...
            if checkWord == wordz:
                notfound = 0
        if notfound == 0 and checkWord != word:
            for letter in word:
                for letters in  checkWord:
                    if letters == letter and i<5:
                        print("\t \t",letters ," present in it ")
                        matchLetters = 0
                        if word.index(letters) == checkWord.index(letter) and i<5:
                            print("\t \t",letter," is at correct position(",checkWord.index(letter)+1,")\n") 
            i= i+1
        elif checkWord != word:
            ...
            report(start, end,i)
            break     
        if matchLetters == 1 and i<5:
            print("\t No matching letters \n")              
